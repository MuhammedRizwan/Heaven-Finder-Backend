import IAdminUsecaseDependencies from "../../domain/entities/depencies/admindependencies.interface";
...
import IAdminUseCase, { AuthResponse, DashboardData, PaginatedResponse } from "../../domain/entities/usecase/adminusecase.interface";
...
export default class AdminUseCase implements IAdminUseCase {
  ...
  constructor(Dependencies: IAdminUsecaseDependencies) {
